...
export default function Footer() {
  return (
    <footer className="bg-primary mt-10 px-14 py-20">
      <div className="flex flex-col md:flex-row w-full">
        <section>
          ...
          <div className="flex flex-col items-start md:items-stretch space-y-4">
            <Input
              type="email"
              placeholder="Email address"
              className="placeholder:text-white text-white"
            />
            <Button className="bg-white text-black rounded-2xl p-6 font-serif">
              SUBSCRIBE
            </Button>
          </div>
        </section>
